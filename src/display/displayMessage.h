...
public:
    ...
    uint32_t getDisplayTextSize() { return this->messageSize - sizeof(DisplayCommand); }

    void serialize(JsonObject& doc) { ESP_LOGE(DISPLAY_TAG, "Display Message not implemented"); }
