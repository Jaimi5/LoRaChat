...
DisplayCommandService::DisplayCommandService() {
    addCommand(Command(
        ...
        DisplayCommand::DisplayOn, 1, [this](String args) {
    ...
    addCommand(Command(
        ...
        DisplayCommand::DisplayOff, 1, [this](String args) {
    ...
    addCommand(Command("/displayBlink",
                       ...
                       DisplayCommand::DisplayBlink, 1, [this](String args) {
                           return String(
                               DisplayService::getInstance().displayBlink(getCommandAddress(args)));
                       }));
    addCommand(Command(
        "/displayClear", "Clear the Display specifying the destination in hex (like the display)",
        DisplayCommand::DisplayClear, 1, [this](String args) {
    ...
    addCommand(Command(
        ...
        DisplayCommand::DisplayLogo, 1, [this](String args) {
    ...
    addCommand(Command("/displayText",
                       ...
                       DisplayCommand::DisplayText, 1, [this](String args) {
